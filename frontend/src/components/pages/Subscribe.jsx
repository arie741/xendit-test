...
function Subscribe() {
  ...
  return (
    <div className="container pt-10">
      ...
      <div className="mb-5">
        Please subscribe to get more information from us!
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} onChange={() => handleOnChange()}>
        ...
        {errors.email && errors.email.type === "pattern" && (
          <div className="text-red-700 my-2" id="subscribe-email-message">Email address is invalid.</div>
        )}
        {successMessage && (
          <div className="text-green-700 my-2" id="subscribe-success-message">{successMessage}</div>
        )}
        {errorMessage && (
          <div className="text-red-700 my-2" id="subscribe-error-message">{errorMessage}</div>
        )}
        <input
